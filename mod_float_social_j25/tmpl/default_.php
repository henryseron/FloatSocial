...
?>
    <div id="ModFloatSocial" style="<?php echo ($module->position == 'left') ? "left: 10px;" : "right: 25px;"?>">
        <?php
    ...
    echo $google_plus_js;
        ...
        ?>
        <div class="g-plus" data-action="share" data-annotation="vertical-bubble" data-height="60" data-href="<?php echo $google_plus_button_url;?>"></div>
        ...
        <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo $facebook_button_url; ?>&width=450&height=65&colorscheme=light&layout=box_count&action=like&show_faces=false&send=<?php echo ($facebook_button_data_send == 'yes') ? "true" : "false"; ?>"
                frameborder="0" width="75" height="<?php echo ($facebook_button_data_send == 'yes') ? "100" : "65"; ?>" scrollbar="no">
        </iframe>
